...
#define ADSP_BXT_DSP_HP_SRAM_SIZE         ADSP_BXT_DSP_SRAM_SIZE
...
/* Uncache */
#define ADSP_BXT_DSP_UNCACHE_BASE     (ADSP_BXT_DSP_HP_SRAM_BASE - 0x20000000)
#define ADSP_BXT_DSP_UNCACHE_SIZE         0x0080000

/* IMR */
#define ADSP_BXT_DSP_IMR_BASE     0xB0000000
#define ADSP_BXT_DSP_IMR_SIZE         0x0080000
