...
#ifndef __ADSP_SUE_H__
#define __ADSP_SUE_H__
...
void adsp_sue_shim_init(struct adsp_dev *adsp, const char *name);
void adsp_sue_shim_msg(struct adsp_dev *adsp, struct qemu_io_msg *msg);
void adsp_sue_irq_msg(struct adsp_dev *adsp, struct qemu_io_msg *msg);
void sue_ext_timer_cb(void *opaque);
